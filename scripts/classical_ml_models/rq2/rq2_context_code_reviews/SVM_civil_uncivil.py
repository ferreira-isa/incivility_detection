...
technical_dataset = "../data/context_lkml/1_features_dataset/civil.csv"
not_technical_dataset = "../data/context_lkml/1_features_dataset/uncivil.csv"

print("Reading datasets...")
civil_data = read_csv(technical_dataset, "civil")
uncivil_data = read_csv(not_technical_dataset, "uncivil")

dataframe = pd.concat([civil_data, uncivil_data])
...
def gen_eda(orig_df_train, alpha_sr, alpha_ri, alpha_rs, alpha_rd, num_aug=9):
	output_train_df = pd.DataFrame(columns=["text_content", "label", "author_role", "is_first_author_thread", "nr_characters", "ratio_words_email_thread", "ratio_words_email_comment", "position_sentence_comment", "position_sentence_thread", "is_last_comment", "time_start_to_email", "time_email_to_end", "time_previous_to_email", "time_email_to_next"])
...
def run_pipelines (pipeline, parameters, pipeline_id):
	...
	EDA_parameters = [#{"alpha_sr": 0.2, "alpha_ri": 0.1, "alpha_rs": 0.05, "alpha_rd": 0.05, "num_aug": 8},
	                  #{"alpha_sr": 0.2, "alpha_ri": 0.1, "alpha_rs": 0.05, "alpha_rd": 0.05, "num_aug": 16},
	                  #{"alpha_sr": 0.2, "alpha_ri": 0.05, "alpha_rs": 0.05, "alpha_rd": 0.05, "num_aug": 8},
	                  {"alpha_sr": 0.2, "alpha_ri": 0.05, "alpha_rs": 0.05, "alpha_rd": 0.05, "num_aug": 16},
	                  #{"alpha_sr": 0.05, "alpha_ri": 0.1, "alpha_rs": 0.05, "alpha_rd": 0.05, "num_aug": 8},
	                  #{"alpha_sr": 0.05, "alpha_ri": 0.1, "alpha_rs": 0.05, "alpha_rd": 0.05, "num_aug": 16},
	                  #{"alpha_sr": 0.05, "alpha_ri": 0.05, "alpha_rs": 0.05, "alpha_rd": 0.05, "num_aug": 8},
	                  #{"alpha_sr": 0.05, "alpha_ri": 0.05, "alpha_rs": 0.05, "alpha_rd": 0.05, "num_aug": 16}
	                  ]

	with open ('output/SVM_civil_uncivil_pipeline'+pipeline_id+'.csv', "a+") as f:
