...
print("non_transform_features: ", non_transform_features)
...
def run_pipelines (pipeline, parameters, pipeline_id):
	...
	EDA_parameters = [{"alpha_sr": 0.05, "alpha_ri": 0.1, "alpha_rs": 0.05, "alpha_rd": 0.05, "num_aug": 8},]

	with open ('output/CART_civil_uncivil_pipeline'+pipeline_id+'.csv', "a+") as f:
