...
print("Original count:", dataframe['label'].value_counts(normalize=False))
...
parameters = {
    ...
    'clf__max_depth': (1, 2, 5, 10, 20, 30, 40, 50),
	...
	with open ('output/CART_technical_non_technical_pipeline'+pipeline_id+'.csv', "a+") as f:
		...
		for parameter in EDA_parameters:
			...
			for train, test in outer_cv.split(X, y):
				...
				print("Train count:", X_train['label'].value_counts(normalize=False))
