...
civil_dataset = "../data/gh/3_features_dataset/civil.csv"
uncivil_dataset = "../data/gh/3_features_dataset/uncivil.csv"
	...
	with open ('output/LR_civil_uncivil_pipeline'+pipeline_id+'.csv', "a+") as f:
		...
		for parameter in EDA_parameters:
			...
			for train, test in outer_cv.split(X, y):
				...
				columns = ["issue_id", "comment_id", "text_content", "quotation_tbdf", "label"]
