	...
	with open ('output/SVM_civil_uncivil_pipeline'+pipeline_id+'.csv', "a+") as f:
		...
		for parameter in EDA_parameters:
			...
			for train, test in outer_cv.split(X_gh, y_gh):
				...
				X_train_augmented = gen_eda(X_train_gh, parameter["alpha_sr"], parameter["alpha_ri"], parameter["alpha_rs"], parameter["alpha_rd"], parameter["num_aug"])  
