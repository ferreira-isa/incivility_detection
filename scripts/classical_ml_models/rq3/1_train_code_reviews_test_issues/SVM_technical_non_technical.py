...
parameters = {
    'features__text_vectorizer__vect__ngram_range': [(1,1)],  # unigrams or bigrams or trigrams
    'clf__C': [0.5],
    'clf__gamma': [0.5],
}
...
### Perform Nested cross-validation and EDA on Pipeline
...
def run_pipelines (pipeline, parameters, pipeline_id):
	...
	with open ('output/SVM_technical_non_technical_pipeline'+pipeline_id+'.csv', "a+") as f:
