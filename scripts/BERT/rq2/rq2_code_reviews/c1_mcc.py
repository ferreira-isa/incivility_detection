...
print("\n\nPREVIOUS MESSAGES context (train and test on concat_body and email_label\n")
...
# read CSV
url_nt = "https://github.com/ahlraf/datasets/raw/main/previous_messages_not_technical_utf.csv"
url_t = "https://github.com/ahlraf/datasets/raw/main/previous_messages_technical_utf.csv"
...
df_train = df[["concat_body", "email_code"]]
# df_train.head()

df_train = df_train.rename(columns = {"concat_body": "text", "email_code": "label"})

df_train["label"] = [0 if x=="not_technical" else 1 for x in df_train["label"]]
