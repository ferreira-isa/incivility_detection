...
# read CSV
url = "https://github.com/ahlraf/datasets/raw/main/previous_messages_final.csv"
...
df_train["label"] = [0 if x=="civil" else 1 for x in df_train["label"]]
...
for fold_i in range(len(folds)):
  ...
  print("\n\nLabel count after augmentation:", Counter(train_labels))
