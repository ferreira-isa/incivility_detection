...
args = TrainingArguments(
    ...
    save_strategy = "epoch",
    learning_rate=1.4578386061584304e-05,
    per_device_train_batch_size=4,
    per_device_eval_batch_size=batch_size,
    num_train_epochs=3,
    weight_decay=0.05984480297859859,
    warmup_steps=500,
...
for fold_i in range(len(folds)):
  ...
  aug_train = gen_eda(train_df, output_train, 0.2, 0.05, 0.05, 0.05, 16)
